...
from .views import UserRegisterView, VerifyEmailView, LoginAPIView, UserRegisterWithoutVerificationView, RequestPasswordResetEmail, PasswordTokenCheckAPI, SetNewPasswordAPIView, LogoutAPIView, UserList
